...
while true; do
  ...
  # E2 live A/B CONCLUDED 2026-08-29 15:20: tracker ON (arm=off) captured
  # 0.529 mean pot share vs 0.392 for tracker OFF (n=40/32, balanced roles).
  # The arena inversion does NOT transfer to the live field — pin tracker ON.
  unset GLEE_ABLATE
  echo "[$(date -Is)] arm=off-pinned" >> "$LOG"
