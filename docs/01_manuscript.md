...
**Statistical treatment.** Error bars are standard errors of the mean over independent games (variability factor: per-game outcome randomness under fixed policies and paired seeds); 95% CIs use the t-approx-2 normal approximation on Welch two-sample t. Arena (n=120/arm, pooled 240 vs 240): tracker-OFF 0.243 +/- 0.016 vs tracker-ON 0.209 +/- 0.014; difference +3.4pp, 95% CI [-0.9, +7.6]pp - not individually significant. Live A/B (19-h alternation window): tracker-ON 0.498 +/- 0.010 (n=246) vs tracker-OFF 0.488 +/- 0.013 (n=173); difference +1.0pp, 95% CI [-2.2, +4.2]pp - no detectable difference. Both CIs are consistent with zero; the theoretically-motivated tracker was retained.
